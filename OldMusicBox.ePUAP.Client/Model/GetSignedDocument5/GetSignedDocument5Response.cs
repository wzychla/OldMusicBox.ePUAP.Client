    ...
    public class GetSignedDocument5Response : IServiceResponse
    {
        ...
        public IEnumerable<string> SigningCertificates
        {
            get
            {
                ...
                var keyInfo              = xml.GetElementsByTagName( "KeyInfo", OldMusicBox.Saml2.Constants.Namespaces.XMLDSIG ).OfType<XmlNode>().FirstOrDefault();
                ...
                if ( keyInfo != null && qualifyingProperties != null )
                {
                    ...
                    ns.AddNamespace( "ds", Saml2.Constants.Namespaces.XMLDSIG );
