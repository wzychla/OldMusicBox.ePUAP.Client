...
using OldMusicBox.ePUAP.Client.Model.TrustedProfileInfoForPESEL;
using System;
...
namespace OldMusicBox.ePUAP.Client
{
    ...
    public class TpUserObjectsInfoClient : BaseClient
    {
        ...
        public TpUserObjectsInfoClient(string serviceUri, X509Certificate2 signingCertificate) : base(serviceUri, signingCertificate)
        {
